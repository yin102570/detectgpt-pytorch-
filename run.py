...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_key', type=str, default="document",
                        help="The column of the dataset you want to use. For instance, the original experiments were ran on the 'document' column of the XSum dataset.")
    ...
    if args.scoring_model_name:
        ...
        if not args.skip_baselines:
            if "base_model" in config:
                ...
                print("Warning: Base model not found, skipping baselines.")
    ...
    if not args.baselines_only:
        if "base_model" in config:
            ...
            print("Warning: Base model not loaded! Skipping DetectGPT experiment.")
